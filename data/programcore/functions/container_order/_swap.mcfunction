#> programcore:container_order/_swap
#
# @within function programcore:container_order/swap
...
execute if score $Value1 Temporary matches 0 positioned ^ ^ ^1 run function programcore:container_order/__swap
execute if score $Value1 Temporary matches 1 positioned ^1 ^ ^ run function programcore:container_order/__swap
execute if score $Value1 Temporary matches 2 positioned ^ ^ ^-1 run function programcore:container_order/__swap
execute if score $Value1 Temporary matches 3 positioned ^-1 ^ ^ run function programcore:container_order/__swap
execute if score $Value1 Temporary matches 4 positioned ~ ~1 ~ run function programcore:container_order/__swap
execute if score $Value1 Temporary matches 5 positioned ~ ~-1 ~ run function programcore:container_order/__swap
