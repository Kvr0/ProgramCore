#> programcore:container_order/_getall
#
# @within function programcore:container_order/getall
...
execute if score $Value0 Temporary matches 0 positioned ^ ^ ^1 if data block ~ ~ ~ Items[0] run function programcore:container_order/_getall_loop
execute if score $Value0 Temporary matches 1 positioned ^1 ^ ^ if data block ~ ~ ~ Items[0] run function programcore:container_order/_getall_loop
execute if score $Value0 Temporary matches 2 positioned ^ ^ ^-1 if data block ~ ~ ~ Items[0] run function programcore:container_order/_getall_loop
execute if score $Value0 Temporary matches 3 positioned ^-1 ^ ^ if data block ~ ~ ~ Items[0] run function programcore:container_order/_getall_loop
execute if score $Value0 Temporary matches 4 positioned ~ ~1 ~ if data block ~ ~ ~ Items[0] run function programcore:container_order/_getall_loop
execute if score $Value0 Temporary matches 5 positioned ~ ~-1 ~ if data block ~ ~ ~ Items[0] run function programcore:container_order/_getall_loop
