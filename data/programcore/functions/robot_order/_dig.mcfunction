#> programcore:robot_order/_dig
#
# @within function programcore:robot_order/dig
...
execute if score $Dir Temporary matches 0 run function programcore:robot_order/_dig0
execute if score $Dir Temporary matches 1 run function programcore:robot_order/_dig1
execute if score $Dir Temporary matches 2 run function programcore:robot_order/_dig2
execute if score $Dir Temporary matches 3 run function programcore:robot_order/_dig3
execute if score $Dir Temporary matches 4 run function programcore:robot_order/_dig4
execute if score $Dir Temporary matches 5 run function programcore:robot_order/_dig5
